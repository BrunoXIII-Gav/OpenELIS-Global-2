...
@Entity
@Table(name = "patient_additional_field_def")
@DynamicUpdate
public class PatientAdditionalFieldDefinition extends BaseObject<Integer> {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "patient_additional_field_def_seq")
    @SequenceGenerator(name = "patient_additional_field_def_seq", sequenceName = "patient_additional_field_def_seq", allocationSize = 1)
    @Column(name = "id")
    private Integer id;
