...
@Entity
@Table(name = "patient_additional_field_option")
@DynamicUpdate
public class PatientAdditionalFieldOption extends BaseObject<Integer> {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "patient_additional_field_option_seq")
    @SequenceGenerator(name = "patient_additional_field_option_seq", sequenceName = "patient_additional_field_option_seq", allocationSize = 1)
    @Column(name = "id")
    private Integer id;
