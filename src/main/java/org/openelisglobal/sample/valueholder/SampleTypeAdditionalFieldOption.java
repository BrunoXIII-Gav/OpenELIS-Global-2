...
@Entity
@Table(name = "sample_type_additional_field_option")
@DynamicUpdate
public class SampleTypeAdditionalFieldOption extends BaseObject<Integer> {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sample_type_additional_field_option_seq")
    @SequenceGenerator(name = "sample_type_additional_field_option_seq", sequenceName = "sample_type_additional_field_option_seq", allocationSize = 1)
    @Column(name = "id")
    private Integer id;
