...
public class CustomAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response,
        ...
        if ("true".equals(request.getParameter("apiCall"))) {
            ...
            if (shouldRedirectSamlFailureToPortal(request, exception)) {
                ...
                redirectStrategy.sendRedirect(request, response, resolveFrontendRoot(request));
                return;
            }
    ...
    private boolean isSamlLogoutResponseRoutedToLoginEndpoint(HttpServletRequest request,
        ...
        return "malformed_response_data".equalsIgnoreCase(errorCode) && uri.contains("/login/saml2/sso")
                && request.getParameter("SAMLResponse") != null && message.contains("LogoutResponseImpl");
    }
