...
@Entity
@Table(name = "test_additional_field_option")
@DynamicUpdate
public class TestAdditionalFieldOption extends BaseObject<Integer> {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "test_additional_field_option_seq")
    @SequenceGenerator(name = "test_additional_field_option_seq", sequenceName = "test_additional_field_option_seq", allocationSize = 1)
    @Column(name = "id")
    private Integer id;
